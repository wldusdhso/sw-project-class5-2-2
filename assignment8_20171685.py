...
class Calculator(QWidget):
    ...
    def buttonClicked(self):
        ...
        keyConstants = ['3.141592', '3E+8', '340', '1.5E+8']
        keyFunctions = [calcFunctions.factorial, calcFunctions.decToBin, calcFunctions.binToDec, calcFunctions.decToRoman]
        ...
        if key == '=':
            ...
            for i,k in enumerate(keyConstants):
                if key == constantList[i]:
                    self.display.setText(self.display.text() + k)
        elif key in functionList:
            for i,k in enumerate(keyFunctions):
