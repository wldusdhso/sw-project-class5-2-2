...
#공통의 속성을 손쉽게 다룰 수 있음, 반복 줄일 수 있음
...
class Calculator(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        numLayout.addWidget(self.digitButton[0], 3, 0)
        for i in range(1, 4):
            numLayout.addWidget(self.digitButton[i], 2, (i - 1) % 3)
            numLayout.addWidget(self.digitButton[i + 3], 1, (i - 1) % 3)
            numLayout.addWidget(self.digitButton[i + 6], 0, (i - 1) % 3)
